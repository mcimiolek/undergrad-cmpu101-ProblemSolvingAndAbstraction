...
; Practice using lists and their abreviations
...
(define (sort lon)
  (cond
    [(empty? lon) '()]
    [(cons? lon) (insert (first lon) (sort (rest lon)))]))
...
(check-expect (insert 5 (list 0 2 2 3 5 6 7 8)) (list 0 2 2 3 5 5 6 7 8))
...
(define (merge-lists lon1 lon2)
  (cond
    ...
    [(and (cons? lon1) (cons? lon2))
     (cond
       [(< (first lon1) (first lon2)) (cons (first lon1) (merge-lists (rest lon1) lon2))]
